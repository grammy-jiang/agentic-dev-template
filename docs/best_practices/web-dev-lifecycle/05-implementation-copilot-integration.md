...
2) **System discipline**: branch protections/rulesets + required checks make quality non-negotiable.
...
### 3) Test-first where it matters (behavior changes)
Copilot is excellent at producing test scaffolding quickly, but you must force discipline:
