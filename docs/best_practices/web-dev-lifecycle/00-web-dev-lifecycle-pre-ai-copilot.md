...
2. **Design →** Copilot scaffolds UI code; you validate UX and accessibility.
3. **Spec/Architecture →** Copilot generates diagrams/contracts; you decide tradeoffs.
4. **Implementation →** Copilot speeds coding; CI + lint + tests enforce quality.
5. **Testing →** Copilot drafts tests; you curate and stabilise.
6. **Review →** Copilot pre‑review + humans gate merge.
7. **Release →** Copilot generates pipelines/docs; you own production risk.
